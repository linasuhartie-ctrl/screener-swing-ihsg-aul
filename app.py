...
# ──────────────────────────────────────────────────────────────────────────────
# 1.  UNIVERSE — ~500 SAHAM IHSG TERLIKUID
# ──────────────────────────────────────────────────────────────────────────────
RAW_TICKERS = """
...
# Ubah string di atas jadi list dan otomatis tambahkan ".JK"
TICKER_UNIVERSE = [ticker.strip() + ".JK" for ticker in RAW_TICKERS.split()]
    ...
    st.markdown(
        ...
        <div style='padding:16px 0 4px;'>
            ...
            <p style='margin:4px 0 0;color:#888;font-size:0.82rem;'>
                ~500 Saham IHSG · End-of-Day Signal · Fundamental Auto-Fetch ·
